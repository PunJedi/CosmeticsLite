...
public class MarbleTiltGame implements MiniGame {
    ...
    public void initGame() {
        ...
        if (newRun) {
            ...
            // Load best score from store on new run
            Integer bestFromStore = MiniGameScoreStore.getInstance().getBest(MiniGameId.from(this));
            if (bestFromStore != null) {
                bestScore = bestFromStore;
            }
        }
