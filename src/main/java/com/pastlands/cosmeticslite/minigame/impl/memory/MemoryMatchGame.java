...
public class MemoryMatchGame implements MiniGame {
    ...
    private void checkBoardComplete() {
        ...
        // All matched! Game complete - set gameOver to true
        // Do NOT auto-advance to next level; wait for user to press Reset
        gameOver = true;
    ...
    @Override
    public int getScore() {
        // For scoring purposes, return moves (lower is better)
        // This allows proper comparison of performance
        return moves;
    }
    ...
    /**
     * Get the number of moves made in this run.
     */
    public int getMoves() {
        return moves;
    }
