...
public final class ClientLayers {
    ...
    public static void onAddLayers(EntityRenderersEvent.AddLayers event) {
        ...
        // WaveyCapes integration: No pre-registration needed!
        // Capes are injected on-demand during rendering when WaveyCapes is present.
        // See CosmeticCapeLayer.render() and WaveyCapesBridge.injectCapeToVanillaLayer()
    }
}