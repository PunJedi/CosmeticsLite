...
public class CosmeticPetMooshroom extends MushroomCow {

    private static final EntityDataAccessor<String> OWNER_UUID =
            SynchedEntityData.defineId(CosmeticPetMooshroom.class, EntityDataSerializers.STRING);

    public CosmeticPetMooshroom(EntityType<? extends MushroomCow> type, Level level) {
        super(type, level);
    ...
    // --- Owner API (PetManager calls setOwner(ServerPlayer) which matches this via polymorphism) ---
