...
/**
 * Cosmetic Pet Pig - a classic pink companion that follows its owner.
 * The original Minecraft pet, friendly and loyal.
 */
public class CosmeticPetPig extends Pig {

    // Data for storing owner UUID
    private static final EntityDataAccessor<String> OWNER_UUID = 
            SynchedEntityData.defineId(CosmeticPetPig.class, EntityDataSerializers.STRING);

    public CosmeticPetPig(EntityType<? extends Pig> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        // No breeding goals - just friendly behavior
    }
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (isOwner(player)) {
            if (!this.level().isClientSide) {
                // Pigs can't sit, but they can oink happily
